					    ...
					    try {
							...
							if(data.startsWith("O")){
								...
								if(con==null){
									...
									int i = stmt.executeUpdate("insert into booking_details(category, date_d, customer_no) values('OIL',now(),'1234567890')");
									if(i>0){
										System.out.println("Values are inserted....");
										SendSMS sendSMS=new SendSMS();
									sendSMS.sendSMS("7010739604", "Oil to be delivered to this customer id=123456");
									sendSMS.sendSMS("9789029498", "Oil Booked..");
									//	doit(gpslocation);
									status=false;
									}else{
