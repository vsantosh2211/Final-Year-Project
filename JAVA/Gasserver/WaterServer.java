					    ...
					    try {
							...
							if(data.startsWith("W")){
								...
								if(con==null){
									...
									int i = stmt.executeUpdate("insert into booking_details(category, date_d, customer_no) values('WATER',now(),'1234567890')");
									if(i>0){
										System.out.println("Values are inserted....");
												SendSMS sendSMS=new SendSMS();
									sendSMS.sendSMS("7010739604", "Water cans to be delivered to this customer id=123456");
									sendSMS.sendSMS("9789029498", "Water Booked..");
									//	doit(gpslocation);
									status=false;
									}else{
